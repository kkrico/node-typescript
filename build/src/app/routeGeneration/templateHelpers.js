...
class ValidationService {
            ...
            if (excessProps.length > 0) {
                ...
                if (propHandling === 'throw-on-extras') {
                    fieldErrors[parent + name] = {
                        ...
                        value: excessProps.reduce((acc, propName) => (Object.assign({ [propName]: value[propName] }, acc)), {}),
                    };
                }
            }
        }
    ...
    validateBuffer(name, value) {
        return Buffer.from(value);
    }
    validateUnion(name, value, fieldErrors, swaggerConfig, subSchemas, parent = '') {
        if (!subSchemas) {
            throw new Error('internal tsoa error: ' +
    ...
    validateIntersection(name, value, fieldErrors, swaggerConfig, subSchemas, parent = '') {
        ...
        subSchemas.forEach(subSchema => {
            ...
            cleanValues = Object.assign(Object.assign({}, cleanValues), cleanValue);
            subFieldErrors.push(subFieldError);
        });
        ...
        if (swaggerConfig.noImplicitAdditionalProperties === 'ignore') {
            return Object.assign(Object.assign({}, value), cleanValues);
        }
    ...
    selfIntersectionExcludingCombinations(modelSchemass) {
        ...
        for (let outerIndex = 0; outerIndex < modelSchemass.length; outerIndex++) {
            let currentCollector = Object.assign({}, modelSchemass[outerIndex][0]);
            for (let innerIndex = outerIndex + 1; innerIndex < modelSchemass.length; innerIndex++) {
                currentCollector = Object.assign({}, this.intersectRefObjectModelSchemas([currentCollector], modelSchemass[innerIndex])[0]);
    ...
    combineProperties(a, b) {
        return { dataType: 'refObject', properties: Object.assign(Object.assign({}, a.properties), b.properties), additionalProperties: a.additionalProperties || b.additionalProperties || false };
    }
    ...
    validateModel(input) {
        ...
        if (modelDefinition) {
            ...
            if (additionalProperties === true || tsoa_route_1.isDefaultForAdditionalPropertiesAllowed(additionalProperties)) {
